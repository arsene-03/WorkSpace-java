...
public class Main_Sring {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		String str4 = new String(bytes); // byte 로 쪼갠 문자열을 복구
		...
		String str7 = "Java Programmintg";
		String str8 = str7.substring(5, 11); // 5,6,7,8,9,10
